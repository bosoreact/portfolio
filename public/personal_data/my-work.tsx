export const MyWork = [
  {
    Campbells: {
      ...
      Other_Tools_Used: ["Next.js", "Github", "Visual Studio Code", "PM2"],
      repository: ""
    },
  },
  {
    COORD: {
      ...
      Learned: [
        ...
        {
          gitlab: [
            "Powerful source code repository platform that I recently discovered. It offers a wide range of features that simplify code maintenance, including integrated pipelines for automated testing and deployment. The platform emphasizes security, ensuring that code is protected and vulnerabilities are minimized.",
  ...
  },
  {
    Submix_Platform: {
      ...
      Learned: [
        ...
        {
          "Linear Kanban board":
            "I learned about another agile project management tool called the Linear Kanban board. Exploring different tools like this allows me to see the various alternatives available and gain insights into what different development teams use for managing their projects effectively.",
        },
        {
          ESLint:
            "During this project, I worked with ESLint, which proved to be a highly effective tool for analyzing and checking my JavaScript code. ESLint's capabilities for code linting and ensuring code quality were invaluable in maintaining a clean and consistent codebase throughout the development process.",
        },
        {
  ...
  },
  {
    Shoes_Shop_Project: {
      ...
      Learned: [
        ...
        {
          Figma:
            "I discovered a powerful design tool called Figma, which greatly aids in creating user interfaces. It offers a wide range of useful features, including CSS styles, and the ability to measure distances between components. Learning and using Figma has significantly enhanced my design workflow and made the UI design process more efficient and effective.",
        },
        {
          Bitbucket:
            "I found that Bitbucket, as another repository storage option, has a distinct advantage over others due to its seamless integration with Jira. This integration between Bitbucket and Jira provides a powerful and streamlined workflow, making it easier to manage code repositories and track project progress in a cohesive manner.",
        },
        {
          "IBM server":
            "In my course, we frequently use IBM servers as the company is a partial sponsor of the program. Initially, navigating through hundreds of functions and services was challenging. However, by delving into the extensive documentation and utilizing customer support, I was able to explore the full potential of the available resources. Personally, I find IBM's cloud service to be very reliable and robust, providing a solid foundation for various projects and applications.",
        },
      ],
      Other_Tools_Used: ["Visual Studio Code", "Live Share", "Github"],
      repository: "https://github.com/vileider/shoes-shop.git"
    },
  },
  {
    bosoreactproject: {
      Brief:
        "I was practicing React in this project, and in pair programming, we created a few semi-projects like a calculator, a rock-paper-scissors game, and CSS animations. Additionally, we used REST API on Node/Express to send data to a MySQL database.",
      Learned: [
        {
        ...
        {
          MySql:
            "I learned a database programming language. I started noticing how important it is to design the database before starting a project.",
        },
        {
          "REST API":
            "I created my own application programming interface to communicate with the database.",
        },
        {
        ...
        {
          "Scrum board":
            "I did not know about Scrum board, but we realized the need for it. We used a semi-Scrum board on Notion, which helped us organize tasks in the project.",
        },
      ],
      Other_Tools_Used: [
        "Visual Studio Code",
  ...
  },
  {
    Shopping_List_App: {
      Brief:
        "I wanted to create an app that would help users create a customized basket for their weekly shopping. The app allowed users to add products to the basket, add their own products, or customize dishes which would automatically fill up the user's basket. I learned a lot during this project.",
      Learned: [
        {
          "Express/Node":
            "I have been learning Node.js and its framework Express to deploy my single web application. During this process, I learned how to set up routes and send JSON objects from the server.",
        },
        {
        ...
        {
          "React-Typescript":
            "Since I already knew TypeScript, I wanted to take it to a higher level, so I started writing a React app combined with TypeScript. It was challenging, but I have been enjoying the process.",
        },
        {
          "Working on branches":
            "As I aimed to adopt a more professional coding approach, I ventured into industry best practices and discovered the significance of working on branches. By utilizing branches, I learned that it not only safeguards the main codebase but also enables the team to work asynchronously.",
        },
      ],
      Other_Tools_Used: [
        "Visual Studio Code",
      ...
      repository: "https://github.com/vileider/shop-in-typescript.git"
    },
  },
  {
    "Dice_Game": {
      Brief:
        "It was my first contact with React. My friend and I were creating a dice game for fun and to learn the basics of React and its functional components.",
      Learned: [
        {
        ...
        {
          "Pair programming":
            "I discovered how beneficial pair programming can be, where one person acts as a navigator, and the other is the driver.",
        },
      ],
  ...
  },
  {
    "PCC_highlands": {
      Brief:
        "I created this website for a local priest as a voluntary project. I wanted to test myself in semi-professional website creation.",
      Learned: [
        {
          Webpacks:
            "It is my first attempt to build a website using a module bundler. I wanted to learn something more advanced and researched something called Webpack. I found it very useful for creating builds and specifying the targeted version of JavaScript.",
        },
        {
          Github:
            "I discovered cloud-based repository storage. I was taking my baby steps with source control and started to see how powerful and beneficial this tool is.",
        },
      ],
      Other_Tools_Used: [
        "Fetch API",
      ...
      repository: "https://github.com/vileider/new_pcc.git"
    },
  },
  {
    First_js_project: {
      ...
      Learned: [
        {
          TypeScript:
            "I took my first steps in TypeScript, and since I was familiar with adding types while programming in C#, it was an entertaining activity to do the same in JavaScript.",
        },
        {
          "JavaScript Classes":
            "I also stared learning classes in JavaScript beacuse it is a fundamental concept in object-oriented programming and can be used to create reusable and organized code structures. ",
        },
        {
          "fetching data":
            "I learned how to use the Fetch API, which helped me to transfer data back and forth.",
        },
        {
      ...
      Other_Tools_Used: ["Visual Studio Code", "Hosting Service"],
      repository: "https://github.com/vileider/first-js-project.git"
    },
  },
  {
    c_sharp_game: {
      Brief:
        "I wanted to come back to my programming passion and started writing a game in Unity using C#. Unity allowed me to generate a JS code with WebGL. It was a simple Wheel of Fortune game,",
      Learned: [
        {
          "Visual Studio":
            "When I started using Visual Studio, which was the default integrated development environment (IDE) for unity, I initially found it a bit complex, especially as a beginner. However, after a few weeks, I became proficient at navigating the platform and even created a simple game.",
        },
        {
          "c-sharp":
            "I learned the basics of C#, coding in its workspaces using loops, variables, simple functions, and working with arrays.",
        },
        {
          "Hosting Service": "I've deployed my applications on a hosting platform, marking a significant milestone and the beginning of the journey into maintaining hosting and servers."
        }
      ],
      Other_Tools_Used: ["Unity"],
      repository: "https://github.com/vileider/unity-c--wheel-of-fortune.git"
    },
  },
];
